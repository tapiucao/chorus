...
from core.schemas import OptionDraft, CritiqueReport, ProjectSpec, ImplementationSpec
...
def exploration_node(state: ChorusState):
    ...
    print("Agent: Explorer (Exploration)")
    system_prompt = build_stage_system_prompt(
        "exploration",
...
def framing_node(state: ChorusState):
    ...
    print("Agent: Architect (Framing Options)")
...
def critic_node(state: ChorusState):
    ...
    print("Agent: Critic (Stress Test)")
...
def mediator_node(state: ChorusState):
    ...
    print("Agent: Mediator (Synthesis)")
...
def implementation_debate_node(state: ChorusState):
    ...
    print("Agent: Implementation Architect (Debate)")
